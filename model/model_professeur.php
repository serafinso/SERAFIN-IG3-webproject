  ...
  */
  ...
  class Professeur{
    ...
    */
    ...
    public static function prof_creer($professeur_nom,$professeur_prenom,$professeur_age,$professeur_telephone, $professeur_email)
    {
        require_once('bd.php');
        $req=$connect->prepare('INSERT INTO professeur(professeur_nom,professeur_prenom,professeur_age,professeur_telephone,professeur_email) VALUES (?,?,?,?,?)');
        /*$req->bindParam(':professeur_nom',$professeur_nom);
        $req->bindParam(':professeur_prenom',$professeur_prenom);
        $req->bindParam(':professeur_age',$professeur_age);
        $req->bindParam(':professeur_telephone',$professeur_telephone);
        $req->bindParam(':professeur_email',$professeur_email);*/
        $req->execute(array($professeur_nom, $professeur_prenom, $professeur_age, $professeur_telephone, $professeur_email));
      }
    ...
    public static function prof_modifier($p_id,$p_nom,$p_prenom,$p_age,$p_telephone, $p_email)
    {
        var_dump($p_id);
        require_once('bd.php');
        $req=$connect->prepare("UPDATE professeur SET professeur_nom=:professeur_nom, professeur_prenom=:professeur_prenom,
           professeur_age=:professeur_age,professeur_telephone= :professeur_telephone,professeur_email=:professeur_email WHERE professeur_id = '$p_id'");
        $req->bindParam(':professeur_nom',$p_nom);
        $req->bindParam(':professeur_prenom',$p_prenom);
        $req->bindParam(':professeur_age',$p_age);
